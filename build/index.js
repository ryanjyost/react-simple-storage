 ...
 * @returns {boolean}
 */
var checkStatefulParent = function checkStatefulParent(parent) {
  return parent instanceof _react.Component;
};
...
var SimpleStorage = function (_Component) {
  ...
  _createClass(SimpleStorage, [{
    ...
    value: function hydrateStateWithStorage() {
      ...
      var isStatefulParent = checkStatefulParent(parent);
      var parentObj = isStatefulParent ? parent.state : parent;
      ...
      _store2.default.each(function (value, key) {
        ...
        if (key.includes(prefix)) {
          ...
          if (isStatefulParent && name in parentObj) {
            ...
            var _parent$name = _slicedToArray(parent[name], 2),
                setValue = _parent$name[1];
    ...
    value: function saveStateToStorage() {
      ...
      Object.entries(parentObj).forEach(function (_ref) {
        ...
        var value = isStatefulParent ? item : item[0];
        if (blacklist.indexOf(key) < 0 && allowNewKey) {
          _store2.default.set(prefix + "_" + key, value);
        }
      });
    }
  }, {
